...
- **Currency family price panel** — checking an essence, soul core, catalyst, rune, omen, or idol fills the side panel with its whole group's prices (e.g. all Greater essences, all tier-3 soul cores, all Ritual omens, every idol), the checked one highlighted — a quick read of the group's going rates. Big groups like the Ritual omens and idols spread across two columns so they all fit at once
