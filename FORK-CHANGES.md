...
- **Essence price group** — checking any essence fills the side panel with its whole tier's prices (all Lesser, Normal, Greater, Perfect, or the six special essences), the checked one highlighted — a quick read of the group's going rates
