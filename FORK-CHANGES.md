...
- **Currency family price panel** — checking an essence, soul core, catalyst, or rune fills the side panel with its whole group's prices (e.g. all Greater essences, all tier-3 soul cores, all regular catalysts), the checked one highlighted — a quick read of the group's going rates
